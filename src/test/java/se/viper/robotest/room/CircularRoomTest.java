...
public class CircularRoomTest {
	...
	public void testSpecificContains() {
		...
		assertTrue(room.contains(new Point(10, 15)));
		assertTrue(room.contains(new Point(15, 10)));
		...
		assertFalse(room.contains(new Point(4, 4)));
		assertFalse(room.contains(new Point(15, 15)));
		assertFalse(room.contains(new Point(42, 42)));
